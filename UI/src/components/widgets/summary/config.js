...
(function () {
    ...
    angular
        ...
        .controller('SummaryConfigController', SummaryConfigController);

    SummaryConfigController.$inject = ['modalData', '$scope', 'collectorData', '$uibModalInstance'];
    function SummaryConfigController(modalData, $scope, collectorData, $uibModalInstance) {
        var ctrl = this,
